 ...
 * 
 * <ul>
 * <li>{@code AllocVertexCount} &ndash; to be filled in by caller of {@link OVR#ovr_GetFovStencil GetFovStencil}</li>
 ...
 * <li>{@code AllocIndexCount} &ndash; to be filled in by caller of {@link OVR#ovr_GetFovStencil GetFovStencil}</li>
...
public class OVRFovStencilMeshBuffer extends Struct implements NativeResource {
    ...
    /** Sets the specified value to the {@code AllocVertexCount} field. */
    ...
    /** Sets the specified value to the {@code AllocIndexCount} field. */
    ...
    /** Returns a new {@code OVRFovStencilMeshBuffer} instance allocated on the thread-local {@link MemoryStack}. */
    public static OVRFovStencilMeshBuffer mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code OVRFovStencilMeshBuffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    ...
    /**
     * Returns a new {@link OVRFovStencilMeshBuffer.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link OVRFovStencilMeshBuffer.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
     ...
     * @param capacity the buffer capacity
     */
    public static OVRFovStencilMeshBuffer.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static OVRFovStencilMeshBuffer.Buffer callocStack(int capacity, MemoryStack stack) {
