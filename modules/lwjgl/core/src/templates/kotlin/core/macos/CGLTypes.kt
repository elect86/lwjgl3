...
val CGLPixelFormatObj = "CGLPixelFormatObj".handle
val CGLRendererInfoObj = "CGLRendererInfoObj".handle
val CGLContextObj = "CGLContextObj".handle
val CGLPBufferObj = "CGLPBufferObj".handle

val CGLShareGroupObj = "CGLShareGroupObj".handle
