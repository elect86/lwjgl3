...
public final class GLCapabilities {
    ...
    static final int ADDRESS_BUFFER_SIZE = 2217;
    ...
    GLCapabilities(FunctionProvider provider, Set<String> ext, boolean fc, IntFunction<PointerBuffer> bufferFactory) {
        ...
        glBufferPageCommitmentMemNV = caps.get(2033);
        glNamedBufferPageCommitmentMemNV = caps.get(2034);
        glTexPageCommitmentMemNV = caps.get(2035);
        glTexturePageCommitmentMemNV = caps.get(2036);
        glDrawMeshTasksNV = caps.get(2037);
        glDrawMeshTasksIndirectNV = caps.get(2038);
        glMultiDrawMeshTasksIndirectNV = caps.get(2039);
        glMultiDrawMeshTasksIndirectCountNV = caps.get(2040);
        glPathCommandsNV = caps.get(2041);
        glPathCoordsNV = caps.get(2042);
        glPathSubCommandsNV = caps.get(2043);
        glPathSubCoordsNV = caps.get(2044);
        glPathStringNV = caps.get(2045);
        glPathGlyphsNV = caps.get(2046);
        glPathGlyphRangeNV = caps.get(2047);
        glPathGlyphIndexArrayNV = caps.get(2048);
        glPathMemoryGlyphIndexArrayNV = caps.get(2049);
        glCopyPathNV = caps.get(2050);
        glWeightPathsNV = caps.get(2051);
        glInterpolatePathsNV = caps.get(2052);
        glTransformPathNV = caps.get(2053);
        glPathParameterivNV = caps.get(2054);
        glPathParameteriNV = caps.get(2055);
        glPathParameterfvNV = caps.get(2056);
        glPathParameterfNV = caps.get(2057);
        glPathDashArrayNV = caps.get(2058);
        glGenPathsNV = caps.get(2059);
        glDeletePathsNV = caps.get(2060);
        glIsPathNV = caps.get(2061);
        glPathStencilFuncNV = caps.get(2062);
        glPathStencilDepthOffsetNV = caps.get(2063);
        glStencilFillPathNV = caps.get(2064);
        glStencilStrokePathNV = caps.get(2065);
        glStencilFillPathInstancedNV = caps.get(2066);
        glStencilStrokePathInstancedNV = caps.get(2067);
        glPathCoverDepthFuncNV = caps.get(2068);
        glPathColorGenNV = caps.get(2069);
        glPathTexGenNV = caps.get(2070);
        glPathFogGenNV = caps.get(2071);
        glCoverFillPathNV = caps.get(2072);
        glCoverStrokePathNV = caps.get(2073);
        glCoverFillPathInstancedNV = caps.get(2074);
        glCoverStrokePathInstancedNV = caps.get(2075);
        glStencilThenCoverFillPathNV = caps.get(2076);
        glStencilThenCoverStrokePathNV = caps.get(2077);
        glStencilThenCoverFillPathInstancedNV = caps.get(2078);
        glStencilThenCoverStrokePathInstancedNV = caps.get(2079);
        glPathGlyphIndexRangeNV = caps.get(2080);
        glProgramPathFragmentInputGenNV = caps.get(2081);
        glGetPathParameterivNV = caps.get(2082);
        glGetPathParameterfvNV = caps.get(2083);
        glGetPathCommandsNV = caps.get(2084);
        glGetPathCoordsNV = caps.get(2085);
        glGetPathDashArrayNV = caps.get(2086);
        glGetPathMetricsNV = caps.get(2087);
        glGetPathMetricRangeNV = caps.get(2088);
        glGetPathSpacingNV = caps.get(2089);
        glGetPathColorGenivNV = caps.get(2090);
        glGetPathColorGenfvNV = caps.get(2091);
        glGetPathTexGenivNV = caps.get(2092);
        glGetPathTexGenfvNV = caps.get(2093);
        glIsPointInFillPathNV = caps.get(2094);
        glIsPointInStrokePathNV = caps.get(2095);
        glGetPathLengthNV = caps.get(2096);
        glPointAlongPathNV = caps.get(2097);
        glMatrixLoad3x2fNV = caps.get(2098);
        glMatrixLoad3x3fNV = caps.get(2099);
        glMatrixLoadTranspose3x3fNV = caps.get(2100);
        glMatrixMult3x2fNV = caps.get(2101);
        glMatrixMult3x3fNV = caps.get(2102);
        glMatrixMultTranspose3x3fNV = caps.get(2103);
        glGetProgramResourcefvNV = caps.get(2104);
        glPixelDataRangeNV = caps.get(2105);
        glFlushPixelDataRangeNV = caps.get(2106);
        glPointParameteriNV = caps.get(2107);
        glPointParameterivNV = caps.get(2108);
        glPrimitiveRestartNV = caps.get(2109);
        glPrimitiveRestartIndexNV = caps.get(2110);
        glQueryResourceNV = caps.get(2111);
        glGenQueryResourceTagNV = caps.get(2112);
        glDeleteQueryResourceTagNV = caps.get(2113);
        glQueryResourceTagNV = caps.get(2114);
        glFramebufferSampleLocationsfvNV = caps.get(2115);
        glNamedFramebufferSampleLocationsfvNV = caps.get(2116);
        glResolveDepthValuesNV = caps.get(2117);
        glScissorExclusiveArrayvNV = caps.get(2118);
        glScissorExclusiveNV = caps.get(2119);
        glMakeBufferResidentNV = caps.get(2120);
        glMakeBufferNonResidentNV = caps.get(2121);
        glIsBufferResidentNV = caps.get(2122);
        glMakeNamedBufferResidentNV = caps.get(2123);
        glMakeNamedBufferNonResidentNV = caps.get(2124);
        glIsNamedBufferResidentNV = caps.get(2125);
        glGetBufferParameterui64vNV = caps.get(2126);
        glGetNamedBufferParameterui64vNV = caps.get(2127);
        glGetIntegerui64vNV = caps.get(2128);
        glUniformui64NV = caps.get(2129);
        glUniformui64vNV = caps.get(2130);
        glProgramUniformui64NV = caps.get(2131);
        glProgramUniformui64vNV = caps.get(2132);
        glBindShadingRateImageNV = caps.get(2133);
        glShadingRateImagePaletteNV = caps.get(2134);
        glGetShadingRateImagePaletteNV = caps.get(2135);
        glShadingRateImageBarrierNV = caps.get(2136);
        glShadingRateSampleOrderNV = caps.get(2137);
        glShadingRateSampleOrderCustomNV = caps.get(2138);
        glGetShadingRateSampleLocationivNV = caps.get(2139);
        glTextureBarrierNV = caps.get(2140);
        glTexImage2DMultisampleCoverageNV = caps.get(2141);
        glTexImage3DMultisampleCoverageNV = caps.get(2142);
        glTextureImage2DMultisampleNV = caps.get(2143);
        glTextureImage3DMultisampleNV = caps.get(2144);
        glTextureImage2DMultisampleCoverageNV = caps.get(2145);
        glTextureImage3DMultisampleCoverageNV = caps.get(2146);
        glCreateSemaphoresNV = caps.get(2147);
        glSemaphoreParameterivNV = caps.get(2148);
        glGetSemaphoreParameterivNV = caps.get(2149);
        glBeginTransformFeedbackNV = caps.get(2150);
        glEndTransformFeedbackNV = caps.get(2151);
        glTransformFeedbackAttribsNV = caps.get(2152);
        glBindBufferRangeNV = caps.get(2153);
        glBindBufferOffsetNV = caps.get(2154);
        glBindBufferBaseNV = caps.get(2155);
        glTransformFeedbackVaryingsNV = caps.get(2156);
        glActiveVaryingNV = caps.get(2157);
        glGetVaryingLocationNV = caps.get(2158);
        glGetActiveVaryingNV = caps.get(2159);
        glGetTransformFeedbackVaryingNV = caps.get(2160);
        glTransformFeedbackStreamAttribsNV = caps.get(2161);
        glBindTransformFeedbackNV = caps.get(2162);
        glDeleteTransformFeedbacksNV = caps.get(2163);
        glGenTransformFeedbacksNV = caps.get(2164);
        glIsTransformFeedbackNV = caps.get(2165);
        glPauseTransformFeedbackNV = caps.get(2166);
        glResumeTransformFeedbackNV = caps.get(2167);
        glDrawTransformFeedbackNV = caps.get(2168);
        glVertexArrayRangeNV = caps.get(2169);
        glFlushVertexArrayRangeNV = caps.get(2170);
        glVertexAttribL1i64NV = caps.get(2171);
        glVertexAttribL2i64NV = caps.get(2172);
        glVertexAttribL3i64NV = caps.get(2173);
        glVertexAttribL4i64NV = caps.get(2174);
        glVertexAttribL1i64vNV = caps.get(2175);
        glVertexAttribL2i64vNV = caps.get(2176);
        glVertexAttribL3i64vNV = caps.get(2177);
        glVertexAttribL4i64vNV = caps.get(2178);
        glVertexAttribL1ui64NV = caps.get(2179);
        glVertexAttribL2ui64NV = caps.get(2180);
        glVertexAttribL3ui64NV = caps.get(2181);
        glVertexAttribL4ui64NV = caps.get(2182);
        glVertexAttribL1ui64vNV = caps.get(2183);
        glVertexAttribL2ui64vNV = caps.get(2184);
        glVertexAttribL3ui64vNV = caps.get(2185);
        glVertexAttribL4ui64vNV = caps.get(2186);
        glGetVertexAttribLi64vNV = caps.get(2187);
        glGetVertexAttribLui64vNV = caps.get(2188);
        glVertexAttribLFormatNV = caps.get(2189);
        glBufferAddressRangeNV = caps.get(2190);
        glVertexFormatNV = caps.get(2191);
        glNormalFormatNV = caps.get(2192);
        glColorFormatNV = caps.get(2193);
        glIndexFormatNV = caps.get(2194);
        glTexCoordFormatNV = caps.get(2195);
        glEdgeFlagFormatNV = caps.get(2196);
        glSecondaryColorFormatNV = caps.get(2197);
        glFogCoordFormatNV = caps.get(2198);
        glVertexAttribFormatNV = caps.get(2199);
        glVertexAttribIFormatNV = caps.get(2200);
        glGetIntegerui64i_vNV = caps.get(2201);
        glViewportSwizzleNV = caps.get(2202);
        glBeginConditionalRenderNVX = caps.get(2203);
        glEndConditionalRenderNVX = caps.get(2204);
        glAsyncCopyImageSubDataNVX = caps.get(2205);
        glAsyncCopyBufferSubDataNVX = caps.get(2206);
        glUploadGpuMaskNVX = caps.get(2207);
        glMulticastViewportArrayvNVX = caps.get(2208);
        glMulticastScissorArrayvNVX = caps.get(2209);
        glMulticastViewportPositionWScaleNVX = caps.get(2210);
        glCreateProgressFenceNVX = caps.get(2211);
        glSignalSemaphoreui64NVX = caps.get(2212);
        glWaitSemaphoreui64NVX = caps.get(2213);
        glClientWaitSemaphoreui64NVX = caps.get(2214);
        glFramebufferTextureMultiviewOVR = caps.get(2215);
        glNamedFramebufferTextureMultiviewOVR = caps.get(2216);
    ...
    private static boolean check_NV_path_rendering(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            2041, 2042, 2043, 2044, 2045, 2046, 2047, 2050, 2052, 2053, 2054, 2055, 2056, 2057, 2058, 2059, 2060, 2061, 2062, 2063, 2064, 2065, 2066, 2067, 
            2068, 2072, 2073, 2074, 2075, 2082, 2083, 2084, 2085, 2086, 2087, 2088, 2089, 2094, 2095, 2096, 2097
        },
    ...
    private static boolean check_NV_shader_buffer_load(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            2120, 2121, 2122, 2123, 2124, 2125, 2126, 2127, 2128, 2129, 2130, 1075, 2131, 2132
        },
    ...
    private static boolean check_NV_vertex_attrib_integer_64bit(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return (checkFunctions(provider, caps, new int[] {
            2171, 2172, 2173, 2174, 2175, 2176, 2177, 2178, 2179, 2180, 2181, 2182, 2183, 2184, 2185, 2186, 2187, 2188, flag0 + 2189
        },
