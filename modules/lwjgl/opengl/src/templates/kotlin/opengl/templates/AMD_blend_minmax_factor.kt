...
val AMD_blend_minmax_factor = "AMDBlendMinmaxFactor".nativeClassGL("AMD_blend_minmax_factor", postfix = AMD) {
    documentation =
        ...
        The #MIN_EXT and #MAX_EXT blend equations, however, do not include the source or destination blend factors in the arguments to the min and max
        ...
        and the destination color and destination factor.
        """
